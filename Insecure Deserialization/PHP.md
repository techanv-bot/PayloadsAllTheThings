...
Also you should check the `Wrapper Phar://` in [File Inclusion](https://github.com/techanvconsulting/PayloadsAllTheThings/tree/master/File%20Inclusion#wrapper-phar) which use a PHP object injection.
